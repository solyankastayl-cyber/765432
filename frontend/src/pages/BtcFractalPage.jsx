...
const BtcFractalPage = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // Fetch BTC fractal signal data
      const response = await fetch(`${API_URL}/api/fractal/signal`);
      ...
      if (result.ok) {
        ...
        const btcData = result;
        const expectedReturn = btcData.exposure || 0;
        const confidence = btcData.confidence || 0.5;
        ...
        const transformedData = {
          ...
          verdict: {
            ...
            rangeP10: finalReturn - 15,
            rangeP90: finalReturn + 20,
            invalidations: [
