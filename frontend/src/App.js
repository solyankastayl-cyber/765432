...
// Overview Page - One-screen market verdict
          ...
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              {/* ═══════════════════════════════════════════════════════════════
                  ...
                  NOTE: /fractal removed - users should select BTC/SPX/DXY
                  ═══════════════════════════════════════════════════════════ */}
              ...
              <Route path="/intelligence/brain" element={<BrainOverviewPage />} />
              
              {/* Overview — One-screen Market Verdict */}
              <Route path="/overview" element={<OverviewPage />} />
              <Route path="/fractal/overview" element={<OverviewPage />} />
              
              {/* Compare Dashboard — V1 vs V2 Institutional Validation */}
              <Route path="/engine/compare" element={<CompareDashboardPage />} />
